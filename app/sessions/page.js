...
const Page = async () => {
  ...
  return (
    <div className={poppins.className}>
      <div class="my-5 w-auto font-bold h-12 flex items-center justify-center text-lg bg-black text-white opacity-70 rounded-sm">Conferences</div>
            ...
            {data &&
              data.map(({ name, value }) => (
                name === "Title" ?
                  ...
                  :
                  name === "Timeslot" ?
                    <div class="hidden w-auto lg:flex md:flex items-center justify-center">{name}: {value}</div>
                    :
                    <>
